...
urlpatterns = [
    ...
    path('projectmanage/', views.get_projectdata),  # 获取所有学生信息的接口
     path('execl/import/',views.import_projectdata_excel),#导入execl的文件
     path('execl/export/', views.export_projectdata_excel),  # 导出Excel文件
]
